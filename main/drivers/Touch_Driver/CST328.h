...
/* Lazily create (once) and return the shared new-driver I2C master bus used by
 * the touch controllers on I2C port I2C_Touch_MASTER_NUM. Both CST328 and
 * CST3530 share this bus so only one of them needs to be present at runtime. */
